...
> behind the iinvest backend demo application.
...
Application should work reasonably well when it is not deployed to GCP
...
Running the application on the GCP must not reduce/lose any of the capabilities
